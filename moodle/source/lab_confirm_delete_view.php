...
echo 'Möchten sie die Ressource wirklich löschen?';
echo $OUTPUT->single_button(new moodle_url('../ausleihverwaltung/lab_resourcelist_view.php', array('id' => $cm->id)), 'Ja');
echo $OUTPUT->single_button(new moodle_url('../ausleihverwaltung/lab_resourcedetail_view.php', array('id' => $cm->id)), 'Nein');
