...
require_once(__DIR__ . '/forms/lab_editApplicationForm.php');
$mform = new labEditApplicationForm();
$mform->render();
//Form processing and displaying is done here
if ($mform->is_cancelled()) {
    //Handle form cancel operation, if cancel button is present on form
    redirect(new moodle_url('../ausleihverwaltung/lab_application_detail_view.php', array('id' => $cm->id)));
