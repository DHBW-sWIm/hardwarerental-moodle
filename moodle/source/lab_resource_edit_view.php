...
require_once(__DIR__ . '/forms/lab_resourceEditForm.php');
...
if ($mform->is_cancelled()) {
    ...
    redirect(new moodle_url('../ausleihverwaltung/lab_resourcedetail_view.php', array('id' => $cm->id, 'resourceid' => $fromform->resourceid)));
} else {
...
echo $OUTPUT->single_button(new moodle_url('../ausleihverwaltung/mai_dhbw_view.php', array('id' => $cm->id)), 'Home');