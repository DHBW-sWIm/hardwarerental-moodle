...
echo $OUTPUT->single_button(new moodle_url('../ausleihverwaltung/stdnt_resource_view.php', array('id' => $cm->id)), 'Show Resources');
echo '<br>';
echo '<br>';

$strName = "Applications:";
echo $OUTPUT->heading($strName);
echo $OUTPUT->single_button(new moodle_url('../ausleihverwaltung/stdnt_applicationlist_view.php', array('id' => $cm->id)), 'My Applications');
echo '<br>';
echo '<br>';
