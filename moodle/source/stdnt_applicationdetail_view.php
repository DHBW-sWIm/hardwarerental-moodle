...
$PAGE->set_url('/mod/ausleihverwaltung/stdnt_applicationdetail_view.php', array('id' => $cm->id, 'applicationid' => $applicationid));
...
require_once(__DIR__ . '/forms/stdnt_ApplicationDetailForm.php');
$mform = new stdntApplicationDetailForm();
$mform->render();
...
if ($mform->is_cancelled()) {
    ...
    redirect(new moodle_url('../ausleihverwaltung/stdnt_confirmcancel_view.php', array('id' => $cm->id, 'applicationid' => $fromform->applicationid)));
} else {
