...
class restore_hardwarerental_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('hardwarerentalVIEWBYID', '/mod/hardwarerental/view.php?id=$1', 'course_module');
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('hardwarerental', 'add', 'view.php?id={course_module}', '{hardwarerental}');
        $rules[] = new restore_log_rule('hardwarerental', 'update', 'view.php?id={course_module}', '{hardwarerental}');
        $rules[] = new restore_log_rule('hardwarerental', 'view', 'view.php?id={course_module}', '{hardwarerental}');
