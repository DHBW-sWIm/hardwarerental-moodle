...
require_once(dirname(__DIR__ ). '/forms/stdnt_ApplicationDetailForm.php');
...
if ($mform->is_cancelled()) {
    ...
    redirect(new moodle_url('./stdnt_confirmcancel_view.php', array('id' => $cm->id, 'applicationid' => $fromform->applicationid)));
} else {
