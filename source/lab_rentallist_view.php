...
$strName = "Vorhandene Ausleihen:";
echo $OUTPUT->heading($strName);

echo '<br>';

$table = new html_table();
$table->head = array('Name', 'Ressource', 'Fääligkeitsdatum', 'Status', 'Details');

$resource = "iPhone 8";
$name = "Henry Stoll";
$status = "Ausgeliehen";
$due = "11.11.2011";
$htmlLink = html_writer::link(new moodle_url('../ausleihverwaltung/lab_rentaldetail_view.php', array('id' => $cm->id, 'resourceid' => $id)), 'Details', $attributes=null);

$table->data[] = array($name, $resource, $due, $status, $htmlLink);
