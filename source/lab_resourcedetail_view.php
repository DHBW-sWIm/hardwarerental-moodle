...
if ($mform->is_cancelled()) {
    ...
    echo ('resource->id'.$fromform->resourceid);
    ...
    $formdata = array('ident' => $resource->id, 'resourceid' => $resourceid, 'serial' => $resource->serial, 'name' => $resource->name, 'type' => $resource->type, 'category' => $resource->category, 'description' => $resource->description, 'status' => $resource->status, 'quantity' => $resource->quantity, 'comment' => $resource->comment, 'id' => $id);
