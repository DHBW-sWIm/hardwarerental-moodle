...
echo $OUTPUT->single_button(new moodle_url('./lab_resourcelist_view.php', array('id' => $cm->id)), 'Ja');
echo $OUTPUT->single_button(new moodle_url('./lab_resourcedetail_view.php', array('id' => $cm->id)), 'Nein');
