...
$document = dirname(dirname("https://{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}"))."/pdf_from_string.php?id=".$document;
$coc = dirname(dirname("https://{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}"))."/pdf_from_string.php?id=".$coc;
