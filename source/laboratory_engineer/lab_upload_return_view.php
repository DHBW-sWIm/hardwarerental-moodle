...
require_once(dirname(__FILE__) . '/forms/lab_uploadReturnForm.php');
$mform = new labUploadReturnForm();

$mform->render();

// Verarbeitung der Formulardaten
if ($mform->is_cancelled()) {
    redirect(new moodle_url('./lab_returnresource_view.php', array('id'=>$cm->id)));
