...
echo $OUTPUT->single_button(new moodle_url('../ausleihverwaltung/lab_resourcelist_view.php', array('id' => $cm->id)), 'Ressourcen ansehen');
echo '<br>';
echo '<br>';

$strName = "Ausleihanträge:";
echo $OUTPUT->heading($strName);
echo $OUTPUT->single_button(new moodle_url('../ausleihverwaltung/lab_applicationlist_view.php', array('id' => $cm->id)), 'Anträge ansehen');
echo '<br>';
echo '<br>';

$strName = "Ausleihen:";
echo $OUTPUT->heading($strName);
echo $OUTPUT->single_button(new moodle_url('../ausleihverwaltung/lab_rentallist_view.php', array('id' => $cm->id)), 'Leihen ansehen');
echo '<br>';
echo '<br>';
